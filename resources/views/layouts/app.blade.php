        ...
        <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
            ...
            <nav class="flex-1 mt-6 px-4 space-y-2">
                ...
                @if (Auth::check() && Auth::user()->role == 'admin')
                    ...
                    <a href="{{ route('peminjaman') }}" class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('peminjaman') ? 'bg-lab-text text-white shadow-md' : 'text-gray-600 hover:bg-lab-pink hover:text-gray-900' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        Peminjaman
                    </a>
                    <a href="{{ route('members.index') }}" class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('members.*') ? 'bg-lab-text text-white shadow-md' : 'text-gray-600 hover:bg-lab-pink hover:text-gray-900' }}">
                ...
                @if (Auth::check() && Auth::user()->role == 'mahasiswa')
                    ...
                    <a href="{{ route('student.loans') }}" class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('student.loans') ? 'bg-lab-text text-white shadow-md' : 'text-gray-600 hover:bg-lab-pink hover:text-gray-900' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        Pinjaman Saya
                    </a>
                @endif
